...
//    public static final String USERNAME = "Test.User2";
//    public static final String PASSWORD = "Test123!";
//    public static final String EMAIL = USERNAME + "@test.com";

    public static final String USERNAME = "TesterSM";
    public static final String PASSWORD = "MyTest@2026";
    public static final String EMAIL = USERNAME + "@demo.com";
    ...
    public static class ProductData {
        ...
        public static final String SPEAKER_NAME_AS_LISTED = "HP Roar Plus Wireless Speaker";
        public static final String TABLET_NAME = "HP ELITEPAD 1000 G2 TABLET";
    }
}
